...
hosts="thorbf003:1,thorbf004:1 "
#hosts="thor003:1,thor004:1 "

OPTS="-x STREAM_NUM_BUFFS=$2 -x STREAM_BUFF_SIZE=$3 "

set -x
mpirun -np 2 -H ${hosts} --bind-to none -x STREAM_THREADS=${1} ${OPTS} -x UCX_TLS=rc_x ./stream-net-pthread2-overlap.exe
